...
class CanLIIScraper(BaseScraper):
    ...
    def _parse_search_result(
        self, result_div, language: str = "en"
    ) -> Optional[CaseData]:
        ...
        try:
            ...
            return CaseData(
                ...
                metadata={"source": "CanLII", "language": language},
            )
    ...
    def _parse_case_detail(self, soup, url: str) -> Optional[CaseData]:
        ...
        try:
            ...
            # Extract full text
            full_text = ""
            content_div = soup.find("div", class_="documentcontent") or soup.find(
                "div", id="document"
            )
            if content_div:
